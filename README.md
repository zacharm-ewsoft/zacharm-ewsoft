...
**[IT Interview Quiz](https://github.com/zacharm-ewsoft/it-quiz)** — Tech interview quiz: Python, Django, SQL, REST API, Linux, Git. Bilingual PL/EN.

---

[Portfolio](https://zacharm-ewsoft.github.io) · [PyPI](https://pypi.org/user/zacharm/) · [Email](mailto:marek@infortel.pl)
